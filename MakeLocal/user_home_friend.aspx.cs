...
public partial class user_home_friend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    if (activationCode == "")
        //    {
        //        if (Session["friend_id"] == null)
        //        {
        //            Response.Redirect("main.aspx");
        //        }
        //        else
        //        {
        //            if (Session["friend_id"].ToString() == "")
        //            {
        //                Response.Redirect("main.aspx");
        //            }
        //        }
        ...
        //    else
        //    {
        //        Session["friend_id"] = activationCode;
        //        Response.Redirect("user_home_friend.aspx");
        //    }
        //}
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        {
            if (Session["id"].ToString().Trim() == "")
            {
                Session.Clear();
                Response.Redirect("main.aspx");
            }
        }
        if (Session["id"] != null && Session["friend_id"] != null)
        {
            if (Session["id"].ToString() == Session["friend_id"].ToString())
            {
  ...
  $(function () {
        ...
        Query += "from user_login where id='" + Session["friend_id"].ToString() + "';";
        ...
        p_head.Controls.Add(new LiteralControl("<div style='background-image: url(" + '"' + cutstr_h1 + '"' + "); background-repeat:no-repeat; background-size: cover; position:absolute; width:100%; height:100%'>"));
        p_head.Controls.Add(new LiteralControl("<table width='100%'>"));
        p_head.Controls.Add(new LiteralControl("<tr>"));
        p_head.Controls.Add(new LiteralControl("<td width='100%' height='100px' align='right' valign='center'>"));
        ...
        p_head.Controls.Add(new LiteralControl("<table style='width:100%; height:100px; position:absolute;bottom:0;'>"));
        p_head.Controls.Add(new LiteralControl("<tr>"));
        p_head.Controls.Add(new LiteralControl("<td class='avartar' rowspan='2' width='10%'>"));
        ...
        ////////user photo on phone
        p_head.Controls.Add(new LiteralControl("<div class='zoom-gallery avartar_mobile'>"));
        cutstr_h = ict_h.Table.Rows[0]["photo"].ToString();
        ind_h = cutstr_h.IndexOf(@"/");
        cutstr_h1 = cutstr_h.Substring(ind_h + 1, cutstr_h.Length - ind_h - 1);
        p_head.Controls.Add(new LiteralControl("<a href='" + cutstr_h1 + "' data-source='" + cutstr_h1 + "' title='" + ict_h.Table.Rows[0]["username"].ToString() + "' style='width:100%;height:100%;'>"));
        p_head.Controls.Add(new LiteralControl("<img src='" + cutstr_h1 + "' width='100px' height='auto' />"));
        p_head.Controls.Add(new LiteralControl("</a>"));
        p_head.Controls.Add(new LiteralControl("</div>"));
        p_head.Controls.Add(new LiteralControl("<br/>"));
        p_head.Controls.Add(new LiteralControl("<span style='color:white;font-weight:bold; font-size: x-large;position:absolute;bottom:60px; margin-left:10px'>"));
        p_head.Controls.Add(new LiteralControl(ict_h.Table.Rows[0]["username"].ToString()));
        p_head.Controls.Add(new LiteralControl("</span>"));
        p_head.Controls.Add(new LiteralControl("</td>"));
        p_head.Controls.Add(new LiteralControl("<td width='35%' valign='top' aligh='right'>"));
        int check_state = 0;
        /////////////


        Query = "select first_check_connect,second_check_connect ";
        Query += "from user_friendship where first_uid='" + Session["id"].ToString() + "' and second_uid='" + Session["friend_id"].ToString() + "';";
        DataView ict_h_fri = gc.select_cmd(Query);
        if (ict_h_fri.Count > 0)
        {
            if ( ict_h_fri.Table.Rows[0]["first_check_connect"].ToString()=="0")
            {
                check_state = 1;
            }
            if (ict_h_fri.Table.Rows[0]["second_check_connect"].ToString() == "0")
            {
                check_state = 2;
            }
            if (ict_h_fri.Table.Rows[0]["first_check_connect"].ToString() == "1" && ict_h_fri.Table.Rows[0]["second_check_connect"].ToString() == "1")
            {
                check_state = 3;
            }
        }
        ...
        Query = "select first_check_connect,second_check_connect ";
        Query += "from user_friendship where first_uid='" + Session["friend_id"].ToString() + "' and second_uid='" + Session["id"].ToString() + "';";
        DataView ict_h_fri1 = gc.select_cmd(Query);
        if (ict_h_fri1.Count > 0)
        {
            if (ict_h_fri1.Table.Rows[0]["first_check_connect"].ToString() == "0")
            {
                check_state = 2;
            }
            if (ict_h_fri1.Table.Rows[0]["second_check_connect"].ToString() == "0")
            {
                check_state = 1;
            }
            if (ict_h_fri1.Table.Rows[0]["first_check_connect"].ToString() == "1" && ict_h_fri1.Table.Rows[0]["second_check_connect"].ToString() == "1")
            {
                check_state = 3;
            }
        }
        ...
        if (check_state == 0)
        {
            Button but_fri = new Button();
            but_fri.Text = "友達になる";
            but_fri.CssClass = "_2_button";
            but_fri.Click += new System.EventHandler(this.addfriend);
            but_fri.OnClientClick = "ShowProgressBar();";
            but_fri.Style["border-style"] = "solid";
            but_fri.Style["border-color"] = "#808080";
            but_fri.Style["width"] = "50%";
            but_fri.Style["height"] = "30px";
            but_fri.Style["cursor"] = "pointer";
            but_fri.ForeColor = System.Drawing.ColorTranslator.FromHtml("#000000");
            but_fri.Font.Bold = true;

            p_head.Controls.Add(but_fri);
        }
        else if (check_state == 1)
        {
            Button but_fri = new Button();
            but_fri.Text = "友達承認";
            but_fri.Click += new System.EventHandler(this.checkfriend);
            but_fri.OnClientClick = "ShowProgressBar();";
            but_fri.Style["border-style"] = "solid";
            but_fri.Style["border-color"] = "#808080";
            but_fri.Style["width"] = "50%";
        ...
        {
            p_head.Controls.Add(new LiteralControl("<input id='home_h' type='button' style='border-style: solid; border-color: #808080; width: 50%; height: 30px; cursor:pointer; ' value='未承認' />"));
        }
        else if (check_state == 3)
        {
            p_head.Controls.Add(new LiteralControl("<input id='home_h' type='button' style='border-style: solid; border-color: #808080; width: 50%; height: 30px; cursor:pointer; ' value='友達' />"));
        }
        ...
        p_head.Controls.Add(new LiteralControl("<input id='home_h1' class='_2_button' type='button' onclick='chat_forfriend()' style='border-style: solid; border-color: #808080; width: 50%; height: 30px; ' value='メッセージを送る' />"));
        ...
        //4 choice
        p_head.Controls.Add(new LiteralControl("<table style='background-color: white; width: 100%; height: 50px; '>"));
        p_head.Controls.Add(new LiteralControl("<tr>"));
        p_head.Controls.Add(new LiteralControl("<td align='center' width='50%' style='border-style: solid;border-width:thin;'>"));
        ...
        p_head.Controls.Add(new LiteralControl("</td>"));
        p_head.Controls.Add(new LiteralControl("<td width='50%' aligh='center' style='border-style: solid;border-width:thin;'>"));
        ...
        Query += " where b.id='" + HttpContext.Current.Session["id"].ToString() + "' and c.id='" + HttpContext.Current.Session["friend_id"].ToString() + "'";
        ...
        Query += " inner join user_login as c on c.id=a.second_uid";
        //check by type use type=0,1
        Query += " where c.id='" + HttpContext.Current.Session["id"].ToString() + "' and b.id='" + HttpContext.Current.Session["friend_id"].ToString() + "'";
        Query += " and first_check_connect=1 and second_check_connect=1;";
...
border-radius: 3px;
        ...
        for (int i = 0; i < ict.Count; i++)
        {
           ...
           // pdn2.Controls.Add(new LiteralControl("<div id='sharebox" + i + "' data-toggle='tooltip' data-html='true' rel='tooltip' title=" + '"' + "<div id = 'html-content" + i + @"' style='display:none;'><div id='shareforpost_" + ict.Table.Rows[i]["id"].ToString() + @"' style='cursor: pointer'>そのままジェア (公開) </div><br/><div id='shareforpost_b" + ict.Table.Rows[i]["id"].ToString() + @"' style='cursor: pointer'>コメントとして投稿</div></div>" + '"' + ">"));
            img1 = new Image();
            img1.Width = 15; img1.Height = 15;
...
//            li.Text = @"
//
//		    	<div id = 'html-content" + i + @"' style='display:none;'>
//<h5>wow <strong>such content</strong> very html</h5>
//<div id='shareforpost_" + ict.Table.Rows[i]["id"].ToString() + @"' style='cursor: pointer'>そのままジェア (公開) </div><br/>
//<div id='shareforpost_b" + ict.Table.Rows[i]["id"].ToString() + @"' style='cursor: pointer'>コメントとして投稿</div>
//		    	</div>
//<script>
//$(document).ready( function(){
//
//$('#sharebox" + i + @"').darkTooltip({
//        trigger:'click',
//		opacity:1,
//		theme:'light',
//        animation:'flipIn',
                        ...
                        <td>
                            <table class='report_dlg' style='width: 100%;'>
                                ...
                                <tr>
                                    ...
                                    <td align='left' width='90%'>
                                        <input type='radio' name='report_" + ict.Table.Rows[i]["id"].ToString() + @"' value='不快または面白くない'> <span style='font-size:medium;'>不快または面白くない</span><br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width='10%'>
                                    ...
                                    <td align='left' width='90%'>
                                        <input type='radio' name='report_" + ict.Table.Rows[i]["id"].ToString() + @"' value='に載せるべきではないと思う'><span style='font-size:medium;'>に載せるべきではないと思う</span><br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width='10%'>
                                    ...
                                    <td align='left' width='90%'>
                                        <input type='radio' name='report_" + ict.Table.Rows[i]["id"].ToString() + @"' value='スパムである'><span style='font-size:medium;'>スパムである</span><br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width='10%'>
...
";
            ...
            Query = "select b.id,b.username from status_messages_user_like as a inner join user_login as b on a.uid=b.id";
            ...
            if (ict3.Count > 1)
            {
                ...
                pdn2.Controls.Add(new LiteralControl("</tr>"));
                pdn2.Controls.Add(new LiteralControl("<tr>"));
                pdn2.Controls.Add(new LiteralControl("<td class='avartar'  width='10%' rowspan='2' valign='top'>"));
...
"));
        ...
        pdn_f.Controls.Add(new LiteralControl("<td class='space' height='5%'></td>"));
        pdn_f.Controls.Add(new LiteralControl("<td width='42%' height='5%'></td>"));
        pdn_f.Controls.Add(new LiteralControl("<td class='space' height='5%'></td>"));
        pdn_f.Controls.Add(new LiteralControl("<td width='42%' height='5%'></td>"));
        pdn_f.Controls.Add(new LiteralControl("<td class='space' height='5%'></td>"));
        pdn_f.Controls.Add(new LiteralControl("</tr>"));
        ...
        for (int i = 0; i < fri.Count; i++)
        {
            ...
            int ind2 = cutstr2.IndexOf(@"/");
            string cutstr3 = cutstr2.Substring(ind2 + 1, cutstr2.Length - ind2 - 1);
            pdn_f.Controls.Add(new LiteralControl("<a href='" + cutstr3 + "' data-source='" + cutstr3 + "' title='" + fri[i].username.ToString() + "' style='width:100%;height:100%;'>"));
        ...
        ////together friend ship panel
        pdn_f = (Panel)this.FindControl("together_friend_Panel");
        pdn_f.Controls.Add(new LiteralControl("<table width='100%'>"));
        pdn_f.Controls.Add(new LiteralControl("<tr>"));
        pdn_f.Controls.Add(new LiteralControl("<td class='space' height='5%'></td>"));
        pdn_f.Controls.Add(new LiteralControl("<td width='42%' height='5%'></td>"));
        ...
        List<friend_list> fri_to = new List<friend_list>();
        frii = new friend_list();
        ...
        for (int i = 0; i < ict_f.Count; i++)
        {
            ...
            {
                if (Convert.ToInt32(ict_f.Table.Rows[i]["id"].ToString()) == fri[ii].id)
                {
                    frii = new friend_list();
                    frii.id = Convert.ToInt32(ict_f.Table.Rows[i]["id"].ToString());
                    frii.photo = ict_f.Table.Rows[i]["photo"].ToString();
        ...
        for (int i = 0; i < ict_f1.Count; i++)
        {
            for (int ii = 0; ii < fri.Count; ii++)
            {
                if (Convert.ToInt32(ict_f1.Table.Rows[i]["id"].ToString()) == fri[ii].id)
                {
                    frii = new friend_list();
                    frii.id = Convert.ToInt32(ict_f1.Table.Rows[i]["id"].ToString());
                    frii.photo = ict_f1.Table.Rows[i]["photo"].ToString();
        ...
        for (int i = 0; i < fri_to.Count; i++)
        {
            ...
            string cutstr2 = fri_to[i].photo.ToString();
            int ind2 = cutstr2.IndexOf(@"/");
            string cutstr3 = cutstr2.Substring(ind2 + 1, cutstr2.Length - ind2 - 1);
            pdn_f.Controls.Add(new LiteralControl("<a href='" + cutstr3 + "' data-source='" + cutstr3 + "' title='" + fri_to[i].username.ToString() + "' style='width:100%;height:100%;'>"));
            pdn_f.Controls.Add(new LiteralControl("<img src='" + cutstr3 + "' width='100%' height='100px' />"));
            pdn_f.Controls.Add(new LiteralControl("</a>"));
            ...
            HyperLink hyy = new HyperLink();
            hyy.NavigateUrl = "~/user_home_friend.aspx?=" + fri_to[i].id.ToString();
            hyy.Target = "_blank";
            hyy.Text = fri_to[i].username.ToString();
            hyy.Font.Underline = false;
            pdn_f.Controls.Add(hyy);
            pdn_f.Controls.Add(new LiteralControl("<br/>"));
            ...
            Query += " inner join user_login as b on b.id=a.first_uid";
            Query += " inner join user_login as c on c.id=a.second_uid";
            Query += " where b.id=" + fri_to[i].id.ToString();
            Query += " and first_check_connect=1 and second_check_connect=1;";
            DataView ict_f2 = gc.select_cmd(Query);
            int how_many_f = ict_f2.Count;
            Query = "select b.id,b.username,b.photo";
            ...
            Query += " inner join user_login as b on b.id=a.first_uid";
            Query += " inner join user_login as c on c.id=a.second_uid";
            Query += " where c.id=" + fri_to[i].id.ToString();
            Query += " and first_check_connect=1 and second_check_connect=1;";
            ict_f2 = gc.select_cmd(Query);
            how_many_f += ict_f2.Count;
    ...
    protected void change_panel(object sender, EventArgs e)
    {
        ...
        else if (temp.ID == "home_h4")
        {
            ...
            buti.ForeColor = System.Drawing.ColorTranslator.FromHtml("#999999");
            buti.Font.Bold = false;
            friend_Panel.Visible = true;
            together_friend_Panel.Visible = false;
            Button13.ForeColor = System.Drawing.ColorTranslator.FromHtml("#000000");
            Button14.ForeColor = System.Drawing.ColorTranslator.FromHtml("#999999");
    ...
    protected void addfriend(object sender, EventArgs e)
    {
        ...
        Query = "insert into user_friendship(first_uid,first_check_connect,second_uid,second_check_connect";
        Query += ",first_date_year,first_date_month,first_date_day,first_date_hour,first_date_minute,first_date_second)";
        Query += " values('" + Session["id"].ToString() + "','1','" + Session["friend_id"].ToString() + "','0'";
        Query += ",'" + year + "','" + month + "','" + day + "','" + hour + "','" + min + "','" + sec + "');";
        resin = gc.insert_cmd(Query);
        Response.Redirect("user_home_friend.aspx");
    }
    protected void checkfriend(object sender, EventArgs e)
    {
        string year = DateTime.Now.Year.ToString();
        string month = DateTime.Now.Month.ToString();
        string day = DateTime.Now.Day.ToString();
        ...
        string min = DateTime.Now.Minute.ToString();
        string sec = DateTime.Now.Second.ToString();
        //SqlDataSource sql_h_fri = new SqlDataSource();
        //sql_h_fri.ConnectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["connStr"].ConnectionString;
        //sql_h_fri.SelectCommand = "select first_check_connect,second_check_connect ";
        //sql_h_fri.SelectCommand += "from user_friendship where first_uid='" + Session["id"].ToString() + "' and second_uid='" + Session["friend_id"].ToString() + "';";
        //sql_h_fri.DataBind();
        //DataView ict_h_fri = (DataView)sql_h_fri.Select(DataSourceSelectArguments.Empty);
        //if (ict_h_fri.Count > 0)
        //{
        //    SqlDataSource sql_h_fri_up = new SqlDataSource();
        //    sql_h_fri_up.ConnectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["connStr"].ConnectionString;
        //    sql_h_fri_up.UpdateCommand = "update user_friendship set first_check_connect='1',first_date_year='" + year + "',first_date_month='" + month + "'";
        //    sql_h_fri_up.UpdateCommand += ",first_date_day='" + day + "',first_date_hour='" + hour + "',first_date_minute='" + min + "',first_date_second='" + sec + "'";
        //    sql_h_fri_up.UpdateCommand += " where first_uid='" + Session["id"].ToString() + "' and second_uid='" + Session["friend_id"].ToString() + "';";
        //    sql_h_fri_up.Update();
        //}
        ...
        if (ict_h_fri1.Count > 0)
        {
            Query = "update user_friendship set second_check_connect='1',second_date_year='" + year + "',second_date_month='" + month + "'";
            Query += ",second_date_day='" + day + "',second_date_hour='" + hour + "',second_date_minute='" + min + "',second_date_second='" + sec + "'";
            Query += " where second_uid='" + Session["id"].ToString() + "' and first_uid='" + Session["friend_id"].ToString() + "';";
...
$('#btnFileUpload_" + param2 + @"').fileupload({
    ...
    [WebMethod]
    public static string chatchat_friend(string param1,string param2)
    {
        GCP_MYSQL gc1 = new GCP_MYSQL();
        string Query1 = "";
        string resin = "";
        string result = "Chat.aspx?_chat=" + param2;
        bool check_have = true;
        Query1 = "select id from user_chat_room";
        Query1 += " where uid='" + param1 + "' and to_uid='" + param2 + "';";
        DataView ict_f = gc1.select_cmd(Query1);
        if (ict_f.Count > 0)
        {
            check_have = false;
        ...
        Query1 = "select id from user_chat_room";
        Query1 += " where to_uid='" + param1 + "' and uid='" + param2 + "';";
        ict_f = gc1.select_cmd(Query1);
        if (ict_f.Count > 0)
        {
            check_have = false;
        ...
        if (check_have)
        {
            ...
            Query1 += " values('" + param1 + "','" + param2 + "','メッセージを送信しよう。','" + year + "','" + mon + "'";
...
<td>
    ...
    public static string search_new_post(string param1)
    {
        ...
        if (HttpContext.Current.Session["friend_id"].ToString() != "")
        {
            //check this friend
            bool check_friend = true;
            Query1 = "select c.id,c.username,c.photo";
            ...
            Query1 += " inner join user_login as c on c.id=a.second_uid";
            //check by type use type=0,1
            Query1 += " where b.id='" + HttpContext.Current.Session["id"].ToString() + "' and c.id='" + HttpContext.Current.Session["friend_id"].ToString() + "'";
            Query1 += " and first_check_connect=1 and second_check_connect=1;";
            ...
            Query1 += " inner join user_login as c on c.id=a.second_uid";
            //check by type use type=0,1
            Query1 += " where c.id='" + HttpContext.Current.Session["id"].ToString() + "' and b.id='" + HttpContext.Current.Session["friend_id"].ToString() + "'";
            Query1 += " and first_check_connect=1 and second_check_connect=1;";
            DataView ict_f1 = gc1.select_cmd(Query1);
            if (ict_f1.Count > 0)
            {
            ...
            Query1 += " where b.id='" + HttpContext.Current.Session["friend_id"].ToString() + "'";
            if (check_friend)
            {
                Query1 += " and a.type!='2'";
            }
...
$('.image-link').magnificPopup({
            ...
            for (int i = 0; i < ict.Count; i++)
            {
                ...
                if (ict.Table.Rows[i]["message"].ToString().Length < 37)
                {
                    result_res += user_home_friend.ConvertUrlsToLinks(ict.Table.Rows[i]["message"].ToString());
                }
                else
                {
                ...
                result_res += "<span style='word-break:break-all;over-flow:hidden;'>" + user_home_friend.ConvertUrlsToLinks(ict.Table.Rows[i]["message"].ToString()) + "</span>";
                ...
                result_res += "</div>";
                result_res += "<div>";
                result_res += "<span style='word-break:break-all;over-flow:hidden;'>" + user_home_friend.ConvertUrlsToLinks_DIV(ict.Table.Rows[i]["message"].ToString()) + "</span>";
                result_res += "</div>";
                result_res += "</td>";
                result_res += "</tr>";
                //poster images
                        ...
                        <td>
                            <table style='width: 100%;'>
                                ...
                                <tr>
                                    ...
                                    <td align='left' width='90%'>
                                        <input type='radio' name='report_" + ict.Table.Rows[i]["id"].ToString() + @"' value='不快または面白くない' style='margin-right: 15px;'> <span style='font-size:medium;vertical-align: super;'>不快または面白くない</span><br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width='10%'>
                                    ...
                                    <td align='left' width='90%'>
                                        <input type='radio' name='report_" + ict.Table.Rows[i]["id"].ToString() + @"' value='に載せるべきではないと思う' style='margin-right: 15px;'><span style='font-size:medium;vertical-align: super;'>に載せるべきではないと思う</span><br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width='10%'>
                                    ...
                                    <td align='left' width='90%'>
                                        <input type='radio' name='report_" + ict.Table.Rows[i]["id"].ToString() + @"' value='スパムである' style='margin-right: 15px;'><span style='font-size:medium;vertical-align: super;'>スパムである</span><br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width='10%'>
...
";
    ...
    {
        friend_Panel.Visible = false;
        together_friend_Panel.Visible = true;
        Button13.ForeColor = System.Drawing.ColorTranslator.FromHtml("#999999");
        Button14.ForeColor = System.Drawing.ColorTranslator.FromHtml("#000000");
    }
    [WebMethod(EnableSession = true)]
