...
public partial class Date_Calendar : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
            ...
            else
            {
                ...
                Query = "insert into user_information_store_PV_UU(suppid,view_uid,view_time)";
                Query += " values('" + sup_id + "','" + id + "',NOW());";
                ...
                Query = "select b.checked,b.week_of_day,b.start_hour,b.start_minute,b.end_hour,b.end_minute";
                Query += " from user_information_store as a";
                Query += " inner join user_information_store_week_appointment as b on a.id=b.uisid";
                Query += " where a.uid='" + sup_id + "';";
                DataView ict_f_w = gc.select_cmd(Query);
                ...
                Query = "select a.photo,a.username,a.CreatedDate,b.id,b.money,b.gov_choice,b.choice1_1,b.choice1_2,b.choice1_3,b.choice1_4,b.howmany,b.age_range_start_year";
                Query += ",b.age_range_start_month,b.age_range_end_year,b.age_range_end_month,b.choice2_1,b.choice2_2,b.choice2_3";
                Query += ",b.choice2_4,b.choice2_5,b.choice2_6,b.choice3_1,b.choice3_2,b.choice3_3,b.choice3_4,b.choice3_5";
                Query += ",b.baby_rule,b.baby_notice,b.choice4_1,b.choice4_2,b.choice4_3,b.choice4_4,b.title,b.myself_content";
                Query += " from user_login as a";
                Query += " inner join user_information_store as b on b.uid=a.id";
                Query += " where a.id='" + sup_id + "';";
                ...
                if (ict_f.Count > 0)
                {
                    ...
                    Query += " from user_information_store_images";
                    Query += " where uisid='" + ict_f.Table.Rows[0]["id"].ToString() + "';";
                    ...
                    Query = "select c.id,a.uid,b.username,b.photo,c.score_message,c.check_time";
                    Query += " from user_information_appointment_check_deal as a";
                    Query += " inner join user_login as b on b.id=a.uid";
                    Query += " inner join user_information_appointment_check_deal_score as c on c.uiacdid=a.id";
                    Query += " where a.suppid='" + sup_id + "';";
                    DataView ict_f_u = gc.select_cmd(Query);
                    if (ict_f_u.Count > 0)
                    {
                    ...
                    for (int i = 0; i < couuuu; i++)
                    {
                        ...
                        hy = new HyperLink();
                        hy.NavigateUrl = "~/user_home_friend.aspx?=" + ict_f_u.Table.Rows[i]["uid"].ToString();
...
";
                        ...
                        Query = "select count(*) as howmany from user_information_appointment_check_deal_score_like";
                        Query += " where uiacdsid='" + ict_f_u.Table.Rows[i]["id"].ToString() + "' and good_status='1';";
                        ...
                        Query = "select good_status from user_information_appointment_check_deal_score_like";
                        Query += " where uiacdsid='" + ict_f_u.Table.Rows[i]["id"].ToString() + "' and uid='" + Session["id"].ToString() + "';";
                    ...
                    Query = "select country,city,Chome";
                    Query += " from user_information";
                    Query += " where uid='" + sup_id + "';";
                    ...
                    if (ict_f2.Count > 0)
                    {
                        ...
                        string addjava=@"<script type='text/javascript' src='https://maps.googleapis.com/maps/api/js?key=AIzaSyAawBtlriaP1wYs4O9ScmRZWF8vlzEmq70&libraries=drawing&language=ja'></script>
                        <script>
        $(function () {
            //定義經緯度位置: 以政大校園的八角亭為例
            ...
            var marker = new google.maps.Marker({
                ...
                map: map //指定要放置的地圖對象
                    ...
                    pan_selct_div.Controls.Add(new LiteralControl("<table width='100%'>"));
                    Query = "select b.id,b.week_of_day,b.week_of_day_jp,b.start_hour,b.start_minute,b.end_hour,b.end_minute from user_information_store as a inner join user_information_store_week_appointment as b on b.uisid=a.id";
                    Query += " where b.checked=1 and a.uid='" + sup_id + "';";
                    DataView ict_f_week = gc.select_cmd(Query);
                    ...
                    pan_selct.Controls.Add(new LiteralControl("<table width='100%'>"));
                    Query = "select id,Sex,birthday_year,birthday_month,birthday_day";
                    Query += " from user_information_school_children";
                    Query += " where uid='" + id + "';";
    ...
    protected void Calendar1_DayRender(object sender, DayRenderEventArgs e)
    {
        ...
        Query = "select checked,day from appointment where uid='" + sup_id + "' and year='" + e.Day.Date.Year + "'";
        Query += " and month='" + e.Day.Date.Month + "';";
        ...
        if (!e.Day.IsOtherMonth && e.Day.Date >= DateTime.Now.Date)
        {
            ...
            if (check_week_day)
            {
                if (check_day)
                {
                    Query = "select * from appointment where uid='" + sup_id + "' and year='" + e.Day.Date.Year + "'";
                    Query += " and month='" + e.Day.Date.Month + "' and day='" + e.Day.Date.Day + "';";
                    DataView ou2 = gc.select_cmd(Query);
    ...
    public static string search_time(string param1, string param2, string param3, string param4)
    {
        ...
        else
        {
            try
            {
                ...
                Query1 = "select start_hour,end_hour from appointment";
                Query1 += " where checked=1 and uid='" + sup_id + "' and year='" + year + "' and month='" + month + "' and day='" + day + "';";
                ...
                if (check_date)
                {
                    Query1 = "select b.start_hour,b.end_hour from user_information_store as a inner join user_information_store_week_appointment as b on b.uisid=a.id";
                    Query1 += " where b.checked=1 and a.uid='" + sup_id + "' and b.week_of_day='" + whichday + "';";
    ...
    public static string Save(string param1, string param2, string param3, string param4, string param5, string param6, string param7, string param8, string param9, string param10, string param11, string param12, string param13, string param14)
    {
        ...
        if (param1 != "" && param2 != "" && param14!="")
        {
            ...
            {
                Query1 = "select id,Sex,birthday_year,birthday_month,birthday_day";
                Query1 += " from user_information_school_children";
                Query1 += " where id='" + kidlist[i] + "';";
                DataView ict_f_user = gc1.select_cmd(Query1);
            ...
            //now time
                 Query1 = "select id,start_hour,end_hour from appointment";
                 Query1 += " where checked=1 and uid='" + param2 + "' and year='" + year + "' and month='" + month + "' and day='" + day + "';";
                 DataView ict_f = gc1.select_cmd(Query1);
            ...
            if (ict_f.Count > 0)
            {
                ...
                for (int i = 0; i < kidlist.Count; i++)
                {
                    Query1 = "insert into user_appointment(appid,uid,start_hour,start_minute,end_hour,end_minute,money_hour,hour,total_money,commission,notice_content,uisccid,howtoget_there,insert_time)";
                    Query1 += " values('" + ict_f.Table.Rows[0]["id"].ToString() + "','" + param1 + "','" + param4 + "','" + param5 + "','" + param6 + "','" + param7 + "','" + param10 + "','" + param9 + "','" + param12 + "','" + param11 + "'";
                    Query1 += ",'" + param8 + "','" + kidlist[i] + "','" + param14 + "','" + start + "')";
                    resin = gc1.insert_cmd(Query1);


                    Query1 = "select id";
                    Query1 += " from user_appointment";
                    Query1 += " where appid='" + ict_f.Table.Rows[0]["id"].ToString() + "' and uid='" + param1 + "' and uisccid='" + kidlist[i] + "' and insert_time='" + start + "';";

                    ict_f_user_f = gc1.select_cmd(Query1);
                ...
                //insert deal case
                Query1 = "insert into user_information_appointment_check_deal(uid,suppid,type,check_success,first_check_time)";
                Query1 += " values('" + param1 + "','" + param2 + "','0','0','" + start + "')";
                resin = gc1.insert_cmd(Query1);

                Query1 = "select id";
                Query1 += " from user_information_appointment_check_deal";
                Query1 += " where uid='" + param1 + "' and suppid='" + param2 + "' and first_check_time='" + start + "';";
                ict_f_user_f = gc1.select_cmd(Query1);
                string dealid = "";
                if (ict_f_user_f.Count > 0)
                {
                ...
                {
                    Query1 = "insert into user_information_appointment_check_connect_deal(uiacdid,uaid)";
                    Query1 += " values('" + dealid + "','" + caseidlist[i] + "')";
                    resin = gc1.insert_cmd(Query1);
                }
                ...
                Query1 += " values('" + param1 + "','" + param2 + "','" + request + "','" + DateTime.Now.Year.ToString() + "','" + DateTime.Now.Month.ToString() + "','" + DateTime.Now.Day.ToString() + "','" + Convert.ToInt32(DateTime.Now.ToString("HH")).ToString() + "','" + DateTime.Now.Minute.ToString() + "','" + DateTime.Now.Second.ToString() + "')";
                resin = gc1.insert_cmd(Query1);
            ...
            {
                Query1 = "select a.id from user_information_store_week_appointment as a inner join user_information_store as b on b.id=a.uisid";
                Query1 += " where checked=1 and b.uid='" + param2 + "' and week_of_day='" + whichdy + "';";
                ...
                if (ict_f1.Count > 0)
                {
                    ...
                    for (int i = 0; i < kidlist.Count; i++)
                    {
                        Query1 = "insert into user_information_store_week_appointment_check(uiswaid,uid,start_hour,start_minute,end_hour,end_minute,money_hour,hour,total_money,commission,notice_content,uisccid,start_date,end_date,howtoget_there,insert_time)";
                        Query1 += " values('" + ict_f1.Table.Rows[0]["id"].ToString() + "','" + param1 + "','" + param4 + "','" + param5 + "','" + param6 + "','" + param7 + "','" + param10 + "','" + param9 + "','" + param12 + "','" + param11 + "'";
                        Query1 += ",'" + param8 + "','" + kidlist[i] + "','" + indate.ToString("yyyy-MM-dd") + "','" + indate.ToString("yyyy-MM-dd") + "','" + param14 + "','" + start + "')";
                        resin = gc1.insert_cmd(Query1);

                        Query1 = "select id";
                        Query1 += " from user_information_store_week_appointment_check";
                        Query1 += " where uiswaid='" + ict_f1.Table.Rows[0]["id"].ToString() + "' and uid='" + param1 + "' and uisccid='" + kidlist[i] + "' and insert_time='" + start + "';";
                    ...
                    //insert deal case
                    Query1 = "insert into user_information_appointment_check_deal(uid,suppid,type,check_success,first_check_time)";
                    Query1 += " values('" + param1 + "','" + param2 + "','1','0','" + start + "')";
                    resin = gc1.insert_cmd(Query1);
                    ...
                    for (int i = 0; i < caseidlist.Count; i++)
                    {
                        Query1 = "insert into user_information_appointment_check_connect_deal(uiacdid,uiswacid)";
                        Query1 += " values('" + dealid + "','" + caseidlist[i] + "')";
                        resin = gc1.insert_cmd(Query1);
                    }
