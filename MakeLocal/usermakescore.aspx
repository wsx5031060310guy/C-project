<%@ Page Language="C#" AutoEventWireup="true" CodeFile="usermakescore.aspx.cs" Inherits="usermakescore" %>
 ...
 line-height: 100%;
    ...
    <script>
        function report_create_success(click_id) {
            ...
            $.ajax({
                type: "POST",
                url: "usermakescore.aspx/report_build_report",
...
<!--hehe-->
		...
		<div class="row">
			<div class="col-md-7  col-md-offset-2">
				<div class="row text_style lead" >評価</div><!--label-->
                <div class="row">
