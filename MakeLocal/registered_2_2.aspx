<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registered_2_2.aspx.cs" Inherits="registered_2_2" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="css/registered_2_2.css">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 50%" align="center">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/step/2/3.PNG" />
                    </td>
                    <td class="space">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 70%" align="center">
                                    ...
                                    <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="Black"
                                        Text="ご利用前に説明動画をお済ませください"></asp:Label>
                                    &nbsp;
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <br />
                                    <asp:Button ID="Button2" runat="server" Text="一覧に戻る" CssClass="file-upload"
