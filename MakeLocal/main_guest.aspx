<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main_guest.aspx.cs" Inherits="main_guest" MaintainScrollPositionOnPostback="true" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function gotodate(click_id) {
            ...
            $.ajax({
                type: "POST",
                url: "main_guest.aspx/changetodate",
                data: "{ param2 :'" + sup_str + "'}",
                ...
                if ($(window).scrollTop() + $(window).height() == $(document).height()) {
                    //alert("bottom!");
                        if (didScroll) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "main_guest.aspx/search_new_post",
                                data: "{param1: '" + count + "'}",
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                async: true,
                            ...
                            <td>
                                <table style="width: 100%; margin-top: 20px">
                                    ...
                                    <tr>
                                        ...
                                        <td><span>
                                            <img src="images/milk_room.png" style="height: 25px; width: 25px;"></span><asp:Button ID="message_type5_Button" runat="server" Text="授乳室" BorderStyle="None" BackColor="transparent" OnClick="message_type5_Button_Click" OnClientClick="ShowProgressBar();" />
                                            <br />
                                            <br />
                                        </td>
                                    </tr>
