...
public partial class twitter_gov_1 : System.Web.UI.Page
{
    string MyConnection2 = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["mysqlConnectionString"].ConnectionString;
    string Query = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["seak"] != null)
        {
            if (Session["seak"].ToString() == "true")
            {
                ...
                PageHTMLBytes = MyWebClient.DownloadData("https://twitter.com/yokohama_KNZW");
                ...
                //indexdiv1_n = cut_hstr1.IndexOf("<strong class=" + "\"" + "fullname js-action-profile-name show-popup-with-id" + "\"" + " data-aria-label-part>");
                ////ListBox7.Items.Add("<strong class=" + "\"" + "fullname js-action-profile-name show-popup-with-id" + "\"" + " data-aria-label-part=" + "\"" + "\"" + ">");
                indexdiv1_n = cut_hstr1.IndexOf("<strong class=" + "\"" + "fullname show-popup-with-id " + "\"" + " data-aria-label-part>");
                cut_hstr2_n = cut_hstr1.Substring(indexdiv1_n + 69, cut_hstr1.Length - indexdiv1_n - 69);
                indexdiv2_n = cut_hstr2_n.IndexOf("</strong>");
                cut_hstr3_n = cut_hstr2_n.Substring(0, indexdiv2_n);
                ListBox7.Items.Add(cut_hstr3_n);
                head_str_uname.Add(cut_hstr3_n);
                ...
                {
                    ListBox11.Items.Add(tmglist[i].messgae);
                    //481752351
                    if (tmglist[i].user_id == "481752351")
                    {
                        gc = new GCP_MYSQL();
                        ...
                        if (ict_fff.Count == 0)
                        {
                            ...
                            Query += " values('" + tmglist[i].mes_id + "','" + tmglist[i].user_id + "','横浜市金沢区役所','" + tmglist[i].messgae + "',";
                            ...
                            Query += " where twitter_mid='" + tmglist[i].mes_id + "' and twitter_uid='" + tmglist[i].user_id + "' and twitter_username='横浜市金沢区役所'";
                            ...
                            DataView ict_fff1 = gc.select_cmd(Query);
                            if (ict_fff1.Count > 0)
                            {
                                string id = ict_fff1.Table.Rows[0]["id"].ToString();
                  ...
                  if (ict_sff.Count > 0)
                        {
                            for (int i = 0; i < ict_sff.Count; i++)
                            {
                                ...
                                message += "<br/><br/>参照元 : 横浜市金沢区役所 Twitter アカウント<br/>";

                                //uid 50
                                Query = "insert into status_messages(uid,type,message_type,place,message,year,month,day,hour,minute,second,postal_code)";
                                Query += " values('103','0','6','横浜市金沢区泥亀2-9-1','" + message + "','" + ict_sff.Table.Rows[i]["year"].ToString() + "','" + ict_sff.Table.Rows[i]["month"].ToString() + "'";
                                Query += ",'" + ict_sff.Table.Rows[i]["day"].ToString() + "','" + ict_sff.Table.Rows[i]["hour"].ToString() + "','" + ict_sff.Table.Rows[i]["minute"].ToString() + "','" + ict_sff.Table.Rows[i]["second"].ToString() + "','236-0021')";

                                resin = gc.insert_cmd(Query);

                                string smid = "";
                                Query = "select id from status_messages";
                                Query += " where uid='103' and type='0' and message_type='6' and place='横浜市金沢区泥亀2-9-1'";
                                ...
                                Query += " and minute='" + ict_sff.Table.Rows[i]["minute"].ToString() + "' and second='" + ict_sff.Table.Rows[i]["second"].ToString() + "' and postal_code='236-0021';";
