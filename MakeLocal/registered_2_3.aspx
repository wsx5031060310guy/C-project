<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registered_2_3.aspx.cs" Inherits="registered_2_3" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="css/registered_2_3.css">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 50%" align="center">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/step/2/4.PNG" />
                    </td>
                    <td class="space">&nbsp;</td>
                </tr>
                <tr>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td align="center" style="width: 80%">
                                    ...
                                    <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="#FF5050"
                                        Text="サービスのすべての機能が利用できます。"></asp:Label>
                                    <br />
                                    <br />
                                    <br />
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <br />
                                    <asp:Button ID="Button2" runat="server" Text="利用する" CssClass="file-upload"
