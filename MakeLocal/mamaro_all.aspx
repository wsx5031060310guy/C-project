<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mamaro_all.aspx.cs" Inherits="mamaro_all" %>
     ...
     <script type="text/javascript">
         ...
         $(document).ready(function () {
             $("#Button1").click(function () {
                 $.ajax({
                     type: "POST",
                     url: "mamaro_all.aspx/check_mamaro",
                     data: "{param1: '" + myDateFormatter($('#datepicker1').val()) + "' , param2 :'" + myDateFormatter($('#datepicker2').val()) + "',param7 :'" + $('#moretime').val() + "' }",
...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
        <fieldset><legend style="font-size: xx-large; font-weight: bold">All mamaro using time</legend>
    <div>
     <br />
        ...
        <br />
         ...
         <input id="Button1" type="button" value="次へ" class="file-upload" style="width: 100%;" />
                ...
                <br /><br />
                <div class="col-md-12">   
                <a href='#' id='export' class="file-upload" style="width: 100%;">Export Table data(csv)</a>
                    </div>
                 <br /><br />
                </div>
            </div>
